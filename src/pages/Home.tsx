...
function Home() {
  return (
    <div
      className='md:bg-maincolor md:m-8 md:h-[600px] h-screen rounded-lg block md:flex justify-between md:flex-row overflow-hidden'>
      <div className='flex flex-col gap-4 pt-24 px-4 md:mt-16'>
        <h3 className='text-xl w-60 md:text-5xl md:w-[650px]'>
      ...
      <div className='relative w-[400px] h-[450px] md:h-[550px] md:absolute md:right-0 md:top-[7.8em]'>
        <Image
